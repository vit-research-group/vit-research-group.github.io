...
Jump to [Principal Investigator](#Principal Investigator), [Team Members](#Team Members), [alumni](#alumni).
...
{% assign number_printed = 0 %}
{% for member in site.data.mscproject %}
...
{% assign number_printed = 0 %}
{% for member in site.data.bscproject %}
